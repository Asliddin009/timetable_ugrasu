...
class _$_SettingState implements _SettingState {
  const _$_SettingState(
      {@JsonKey(ignore: true) this.asyncSnapshot, required this.themeMode});
  ...
  @override
  String toString() {
    return 'SettingState(asyncSnapshot: $asyncSnapshot, themeMode: $themeMode)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, asyncSnapshot, themeMode);
